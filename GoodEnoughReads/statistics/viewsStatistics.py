...
def statistics(request):
    ...
    bar_graph = stats.CreatePlotlyBarGraph(list(books_per_month.keys()), list(books_per_month.values()), "Months", "Number of Books Read")
    ...
    bar_line = stats.CreatePlotlyLineGraph(list(books_per_year.keys()), list(books_per_year.values()), "Year", "Number of Books Read")
    ...
    pie_chart = stats.CreatePlotlyPieChart(list(book_pages_this_year.keys()), list(book_pages_this_year.values()), "Book Pages you Read this year")
