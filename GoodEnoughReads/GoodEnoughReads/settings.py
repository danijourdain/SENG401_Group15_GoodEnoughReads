"""
Django settings for GoodEnoughReads project.
...
ROOT_URLCONF = "GoodEnoughReads.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, 'gersiteapp/templates')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "GoodEnoughReads.wsgi.application"
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'Statistics/media')
